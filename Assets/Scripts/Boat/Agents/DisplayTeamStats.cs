...
public class DisplayTeamStats : MonoBehaviour
{
    public BoatAgents RedAgent;
    public BoatAgents BlueAgent;
    ...
    void OnGUI()
    {
        ...
        GUI.BeginGroup(new Rect(x:0, y:0, width:300, height:350), bgStyle);
